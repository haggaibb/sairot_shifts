...
class _SystemSettingsPageState extends State<SystemSettingsPage> {
  ...
  final TextEditingController editEventController = TextEditingController();
  final TextEditingController delEventController = TextEditingController();
  ...
  late String selectedEditEvent;
  late String selectedDelEvent;
  ...
  void initState() {
    ...
    selectedEditEvent = eventsList[0];
    selectedDelEvent = eventsList[0];
  }
            ...
            backgroundColor: Colors.grey[100],
              ...
              body: Padding(
                ...
                child: Obx(() => !controller.loading.value
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                const Text('הגדרות ארוע פעיל' , style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                                Card(
                                  child: Column(
                                    children: [
                                      Row(
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('מנהלי מערכת' , style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                                Card(
                                    child: Column(
                                      children: [
                                        Row(
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                const Text('הרצת שיבוץ לארוע' , style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                                Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        const Text(''),
                                        const Text('שים לב!!!', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                                        const Text('הרצה של שיבוץ תימחק את כל הנתונים', style: TextStyle(fontSize: 12),),
                                        const Text('של השיבוצים, ההחלפות והמסירות', style: TextStyle(fontSize: 12)),
                                        const Text('של הארוע', style: TextStyle(fontSize: 12)),
                                        DropdownMenu<String>(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('עריכת ארוע' , style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                                Card(
                                    child: Column(
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: SizedBox(
                                                width: 170,
                                                child: DropdownMenu<String>(
                                                  initialSelection: selectedEditEvent,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async {
                                                  final adminEvent = await controller.loadAdminEvent(selectedEditEvent);
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (_) => CreateNewEvent(existingEvent: adminEvent),
                                                    ),
                                                  );
                                                },
                                                child: const Text('עריכת האירוע'),
                                              ),
                                            )
                                          ],
                                        ),
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('מחיקת ארוע' , style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                                Card(
                                    child: Column(
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: SizedBox(
                                                width: 170,
                                                child: DropdownMenu<String>(
                                                  initialSelection: selectedDelEvent,
                                                  controller: delEventController,
                                                  requestFocusOnTap: true,
                                                  label: const Text('ארוע'),
                                                  onSelected: (String? event) {
                                                    setState(() {
                                                      selectedDelEvent = event??'';
                                                    });
                                                  },
                                                  dropdownMenuEntries: eventsList
                                                      .map<DropdownMenuEntry<String>>(
                                                ...
                                                onPressed: () async {
                                                  bool? res = await showDialog<bool>(
                                                      ...
                                                      builder: (BuildContext context) =>
                                                          AdminPinDialog(controller.admins));
                                                  if (res??false) {
                                                    controller.deleteEvent(selectedDelEvent);
                                                  }
                                                  else {
                                                    /// TODO snack msg
                                                    print('not a valid admin');
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(controller.statusMsg.value, style: const TextStyle(fontSize: 20),),
