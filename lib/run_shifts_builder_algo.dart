...
Future<bool> runShiftsBuilderAlgo(String targetEvent) async {
  ...
  print('@@@@@@@@@@@@');
  print(eventInstructorsDocRef.path);
  final eventInstructorsSnap = await eventInstructorsDocRef.where('max_days', isGreaterThan: 0).get();
  ...
  controller.statusMsg.value = 'Got the list(${eventInstructorsSnap.docs.length}) of instructors for the event $eventName';
